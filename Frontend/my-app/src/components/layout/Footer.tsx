      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-muted-foreground text-sm leading-relaxed">
              Leading supplier of industrial and marine equipment, serving clients globally with quality products and reliable service since 2005.
            </p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-center space-x-2">
                ...
                <span className="text-muted-foreground text-sm">info@svexim.com</span>
              </li>
        ...
        <div className="border-t border-border mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-muted-foreground text-sm">
            © 2024 SV Exim. All rights reserved.
          </p>
